...
var SelectableGroup = (function (_super) {
    ...
    function SelectableGroup() {
        ...
        _this.disableSelectStartCheckCache = new Map();
        _this.disableSelectStartList = _this.props.disableSelectStartList;
        _this.disableSelectStartListNodes = [];
        ...
        _this.mouseDown = function (e) {
            ...
            _this.updateWhiteListNodes();
            _this.updateDisableSelectStartListNodes();
            if (_this.isInIgnoreList(e.target)) {
                _this.mouseDownStarted = false;
                return;
            }
            if (_this.isInDisableSelectStartList(e.target)) {
                _this.mouseDownStarted = false;
                return;
            }
    ...
    SelectableGroup.prototype.isInDisableSelectStartList = function (target) {
        if (!target) {
            return;
        }
        ...
        var shouldBeIgnored = this.disableSelectStartListNodes.some(function (disableSelectStartNode) {
            return target === disableSelectStartNode || disableSelectStartNode.contains(target);
        });
    ...
    SelectableGroup.prototype.updateDisableSelectStartListNodes = function () {
