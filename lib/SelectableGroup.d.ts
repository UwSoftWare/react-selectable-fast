...
declare class SelectableGroup extends Component<TSelectableGroupProps> {
    ...
    disableSelectStartCheckCache: Map<HTMLElement, boolean>;
    disableSelectStartList: string[];
    ...
    isInDisableSelectStartList(target: HTMLElement | null): boolean | undefined;
    updateWhiteListNodes(): void;
    updateDisableSelectStartListNodes(): void;
